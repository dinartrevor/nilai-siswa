      ...
      <div class="card">
        <div class="card-header">
          <div class="row align-items-center">
            <div class="col-8">
              <h3 class="mb-0">Edit Kelas & Jurusan</h3>
            </div>
        ...
        <div class="card-body">
          <form action="{{route('updateKelas', $kelas)}}" method="POST">
            {{ csrf_field() }}
            <div class="pl-lg-4">
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <input type="text" id="input-username" class="form-control" value="{{$kelas->nama_kelas}}" name="nama_kelas">
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="form-group">
                    <label class="form-control-label" for="input-username">Tahun Ajaran</label>
                    <input type="text" id="input-username" class="form-control" value="{{$kelas->tahun_ajaran}}" name="tahun_ajaran">
                  </div>
                </div>
                <div class="col-lg-12">
                  <div class="form-group">
                    <label class="form-control-label" for="input-username">Jurusan</label>
                    <input type="text" id="input-username" class="form-control" value="{{$kelas->nama_jurusan}}" name="nama_jurusan">
                  </div>
                </div>
              </div>
